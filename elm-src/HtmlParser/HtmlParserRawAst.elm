...
parseTagAttribute = createParseSequenceFunction
...
parseTagAttributes = createOptionallyParseMultipleFunction parseTagAttribute
...
parseClosingCommentIgnore = createParseTokenIgnoreFunction ClosingComment
...
xhtmlToRawAst s =
    let
        (result, _) = parseHtmlTokens <| tokenize s
    in
        result
