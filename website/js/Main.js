...
var _user$project$Parser_ParserHelpers$flattenAstNode = function (astNode) {
	...
	if (_p3.ctor === 'UnlabelledAstNode') {
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Parser.ParserHelpers',
			{
				start: {line: 148, column: 9},
				end: {line: 156, column: 76}
			},
			...
			case 'HtmlUpdated':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{
							html: _p1,
							elmCode: A2(_user$project$HtmlToElm_HtmlToElm$htmlToElm, 4, _p1)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'LoadSnippet':
