...
Elm.Console.Core.make = function (_elm) {
   ...
   var mapF = F2(function (f,iof) {
      ...
      {case "PutS": return A2(PutS,
         ...
         case "GetC": return GetC(function (_p2) {
              return f(_p0._0(_p2));
           });
         case "Exit": return Exit(_p0._0);
         default: return A2(WriteF,
           _p0._0,
           function (_p3) {
              return f(_p0._1(_p3));
           });}
   ...
   var seq = F2(function (x,y) {
      return A2(_op[">>="],x,function (_p5) {    return y;});
   });
   _op[">>>"] = seq;
   ...
   var readUntil = function (end) {
      var go = function (s) {
         ...
         getChar,
         function (c) {
            return _U.eq(c,end) ? pure(s) : go(A2($String.append,
            s,
            A2($String.cons,c,"")));
         });
      };
   ...
   var putStrLn = function (s) {
      return A2(_op[">>>"],putStr(s),putChar(_U.chr("\n")));
   };
...
Elm.Console.NativeCom.make = function (_elm) {
   ...
   if (_elm.Console.NativeCom.values)
   return _elm.Console.NativeCom.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var sendRequestBatch = function (requests) {
      return $Native$Console$NativeCom.sendRequestBatch(requests);
   };
   var sendRequests = function (requests) {
      return A2($Signal.map,sendRequestBatch,requests);
   };
   var Init = {ctor: "Init"};
   var WriteFile = function (a) {
      return {ctor: "WriteFile",_0: a};
   };
   var Get = {ctor: "Get"};
   var Exit = function (a) {    return {ctor: "Exit",_0: a};};
...
Elm.Console.Runner.make = function (_elm) {
   ...
   if (_elm.Console.Runner.values)
   return _elm.Console.Runner.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   var _op = {};
   var mapFst = F2(function (f,_p0) {
      var _p1 = _p0;
      return {ctor: "_Tuple2",_0: f(_p1._0),_1: _p1._1};
   });
   var put = F2(function (s,_p2) {
      return {ctor: "_Tuple2",_0: s,_1: {ctor: "_Tuple0"}};
   });
   var get = function (s) {
      return {ctor: "_Tuple2",_0: s,_1: s};
   };
   _op[">>="] = F3(function (f,k,s) {
      var _p3 = f(s);
      var s$ = _p3._0;
      var y = _p3._1;
      return A2(k,y,s$);
   ...
   var extractRequests = function (io) {
      ...
      if (_p5.ctor === "Pure") {
            return pure({ctor: "_Tuple2"
                        ,_0: _U.list([exit(0)])
                        ,_1: function (_p6) {
                           return $Console$Core.Pure(_p5._0);
                        }});
         } else {
            var _p7 = _p5._0;
            switch (_p7.ctor)
            {case "PutS": return A2(mapSt,
                 mapFst(function (rs) {
                    return A2($List._op["::"],putS(_p7._0),rs);
                 }),
                 pure({ctor: "_Tuple2",_0: _U.list([]),_1: _p7._1}));
               case "WriteF": return A2(mapSt,
                 mapFst(function (rs) {
                    return A2($List._op["::"],writeF(_p7._0),rs);
                 }),
                 pure({ctor: "_Tuple2",_0: _U.list([]),_1: _p7._1}));
               case "Exit": return pure({ctor: "_Tuple2"
                                        ,_0: _U.list([exit(_p7._0)])
                                        ,_1: function (_p8) {
                                           return io;
                                        }});
               default: return A2(_op[">>="],
                 ...
                 function (st) {
                    ...
                    if (_p9.ctor === "Nothing") {
                          ...
                          return A2(_op[">>="],
                          put({buffer: _p9._0._1}),
                          function (_p11) {
                             return extractRequests(_p7._0(_p9._0._0));
                          });
                       }
                 });}
         }
   ...
   var flattenReqs = function (rs) {
      var loop = F3(function (rs,acc,n) {
         loop: while (true) if (_U.cmp(n,100) > -1)
         return $Trampoline.Continue(function (_p14) {
                     ...
                     if (_p15._1.ctor === "[]") {
                           ...
                           _v9_2: do {
                              if (_p16.ctor === "_Tuple2") {
                                    switch (_p16._0.ctor)
                                    {case "Exit": var _v10 = _U.list([]),
                                         _v11 = A2($List._op["::"],_p17,acc),
                                         _v12 = _p16._0._0 + 1;
                                         rs = _v10;
                                         acc = _v11;
                                         n = _v12;
                                       ...
                                       case "Put": if (_p16._1.ctor === "Put") {
                                               var _v13 = A2($List._op["::"],
                                               putS(A2($Basics._op["++"],_p16._0._0,_p16._1._0)),
                                               _p19),
                                               _v14 = acc,
                                               _v15 = n + 1;
                                               rs = _v13;
                           ...
                           var _v16 = A2($List._op["::"],_p18,_p19),
                           _v17 = A2($List._op["::"],_p17,acc),
                           _v18 = n + 1;
                           rs = _v16;
                           acc = _v17;
                           n = _v18;
   ...
   var start = {buffer: ""};
   var run = function (io) {
      var third = function (_p20) {
         var _p21 = _p20;
         return _p21._2;
      };
      var f = F2(function (resp,_p22) {
         var _p23 = _p22;
         return A3(step,resp,_p23._0,_p23._1);
      });
      var init = {ctor: "_Tuple3"
                 ...
                 ,_1: start
                 ,_2: _U.list([$Console$NativeCom.Init])};
      return $Console$NativeCom.sendRequests(A2($Signal.map,
      third,
      A3($Signal.foldp,f,init,$Console$NativeCom.responses)));
   };
...
Elm.ElmTest.Assertion.make = function (_elm) {
   ...
   var assertNotEqual = F2(function (a,b) {
   ...
   var AssertEqual = F3(function (a,b,c) {
      return {ctor: "AssertEqual",_0: a,_1: b,_2: c};
   });
   var assertEqual = F2(function (a,b) {
   ...
   var assertionList = F2(function (xs,ys) {
      return A3($List.map2,assertEqual,xs,ys);
   });
   ...
   var assert = function (b) {
      return AssertTrue(function (_p2) {    return b;});
   };
...
Elm.ElmTest.Test.make = function (_elm) {
   ...
   var suite = Suite;
   var TestCase = F2(function (a,b) {
      return {ctor: "TestCase",_0: a,_1: b};
   });
   var test = F2(function (name,a) {
   ...
   var equals = F2(function (a,b) {
      return defaultTest(A2($ElmTest$Assertion.assertEqual,a,b));
   });
...
Elm.ElmTest.Run.make = function (_elm) {
   ...
   var pass = function (m) {
      ...
      {case "Pass": return true;
         ...
         default: return _U.cmp($List.length(function (_) {
              return _.failures;
           }(_p10._1)),
           0) > 0 ? false : true;}
   };
   var fail = function (_p11) {
      return $Basics.not(pass(_p11));
   };
   ...
   var run = function (test) {
      ...
      if (_p12.ctor === "TestCase") {
            var _p14 = _p12._0;
            var runAssertion = F2(function (t,m) {
               return t({ctor: "_Tuple0"}) ? Pass(_p14) : A2(Fail,_p14,m);
            });
            var _p13 = _p12._1;
            switch (_p13.ctor)
            {case "AssertEqual": return A2(runAssertion,
                 ...
                 A2($Basics._op["++"],
                 _p13._1,
                 A2($Basics._op["++"],"; got: ",_p13._2))));
               case "AssertNotEqual": return A2(runAssertion,
                 _p13._0,
                 A2($Basics._op["++"],
                 _p13._1,
...
Elm.ElmTest.Runner.String.make = function (_elm) {
   ...
   var replicate = F2(function (n,c) {
      var go = function (n) {
         return _U.cmp(n,0) < 1 ? _U.list([]) : A2($List._op["::"],
         c,
         go(n - 1));
      };
      return function (_p0) {
   ...
   var pretty = F2(function (n,result) {
      ...
      var _p3 = result;
      switch (_p3.ctor)
      {case "Pass": return _U.list([{ctor: "_Tuple2"
                                    ,_0: A2(indent,n,A2($Basics._op["++"],_p3._0,": passed."))
                                    ,_1: result}]);
         case "Fail": return _U.list([{ctor: "_Tuple2"
                                      ,_0: A2(indent,
                                      n,
                                      A2($Basics._op["++"],
                                      _p3._0,
                                      A2($Basics._op["++"],": FAILED. ",_p3._1)))
                                      ,_1: result}]);
         default: var allPassed = _U.eq($ElmTest$Run.failedTests(result),
           0);
           var subResults = allPassed ? _U.list([]) : A2($List.concatMap,
           pretty(n + 2),
           _p3._1.results);
           ...
           return A2($List._op["::"],
           {ctor: "_Tuple2",_0: A2(indent,n,msg),_1: result},
           subResults);}
   });
   var run = function (t) {
      var tests = function () {
   ...
   var runDisplay = function (t) {
      ...
      if (_p7.ctor === "::" && _p7._0.ctor === "_Tuple2") {
            ...
            A2($Basics._op["++"],_p7._0._0,"\n"),
            A2($List.map,$Basics.fst,_p7._1)));
         } else {
            return "";
         }
   };
   return _elm.ElmTest.Runner.String.values = {_op: _op
...
Elm.ElmTest.Runner.Element.make = function (_elm) {
   ...
   var maxOrZero = function (l) {
      return A3($List.foldl,$Basics.max,0,l);
   };
   ...
   return _elm.ElmTest.Runner.Element.values = {_op: _op
                                               ,runDisplay: runDisplay};
};
Elm.ElmTest = Elm.ElmTest || {};
Elm.ElmTest.Runner = Elm.ElmTest.Runner || {};
...
Elm.ElmTest.Runner.Console.make = function (_elm) {
   ...
   return _elm.ElmTest.Runner.Console.values = {_op: _op
                                               ,runDisplay: runDisplay};
};
Elm.ElmTest = Elm.ElmTest || {};
...
Elm.Parser.Tokenizer = Elm.Parser.Tokenizer || {};
Elm.Parser.Tokenizer.make = function (_elm) {
   "use strict";
   _elm.Parser = _elm.Parser || {};
   _elm.Parser.Tokenizer = _elm.Parser.Tokenizer || {};
   if (_elm.Parser.Tokenizer.values)
   return _elm.Parser.Tokenizer.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var consumeToken = F2(function (_p0,s) {
      var _p1 = _p0;
      var regexString$ = A2($Basics._op["++"],"^",_p1._1);
      var regex$ = $Regex.regex(regexString$);
      var _p2 = A3($Regex.find,$Regex.AtMost(1),regex$,s);
      if (_p2.ctor === "[]") {
            return $Maybe.Nothing;
         } else {
            var remainder = A4($Regex.replace,
            $Regex.AtMost(1),
            regex$,
            function (_p3) {
               return "";
            ...
            return $Maybe.Just({ctor: "_Tuple2",_0: token,_1: remainder});
         }
   });
   var consumeFirstTokenMatch = F2(function (tokenRecipes,s) {
      consumeFirstTokenMatch: while (true) {
         var _p4 = tokenRecipes;
         if (_p4.ctor === "[]") {
               return $Maybe.Nothing;
            } else {
               var _p5 = A2(consumeToken,_p4._0,s);
               if (_p5.ctor === "Nothing") {
                     var _v4 = _p4._1,_v5 = s;
                     tokenRecipes = _v4;
                     s = _v5;
   ...
   var Word = {ctor: "Word"};
   var Whitespace = {ctor: "Whitespace"};
   var Dash = {ctor: "Dash"};
   ...
   var LeftAngleBracket = {ctor: "LeftAngleBracket"};
   var reservedCharTokenLookup = _U.list([{ctor: "_Tuple2"
                                          ,_0: LeftAngleBracket
                                          ,_1: "<"}
                                         ,{ctor: "_Tuple2",_0: LeftAngleBracket,_1: "<"}
   ...
   var wordRegex = function () {
      var reservedChars = A3($List.foldl,
      F2(function (_p6,s) {
         var _p7 = _p6;
         return A2($Basics._op["++"],s,_p7._1);
      }),
      "",
   ...
   var wildcards = _U.list([{ctor: "_Tuple2"
                            ,_0: Whitespace
                            ,_1: "(\\s)+"}
                           ,{ctor: "_Tuple2",_0: Word,_1: wordRegex}]);
   var ClosingComment = {ctor: "ClosingComment"};
   var OpeningComment = {ctor: "OpeningComment"};
   var specialSequences = _U.list([{ctor: "_Tuple2"
                                   ,_0: OpeningComment
                                   ,_1: "<!--"}
                                  ,{ctor: "_Tuple2",_0: ClosingComment,_1: "-->"}]);
   var tokenizerGrammar = A2($Basics._op["++"],
   specialSequences,
   A2($Basics._op["++"],reservedCharTokenLookup,wildcards));
   var tokenize = function (s) {
      var tokenize$ = F2(function (accTokens,remainderString) {
         tokenize$: while (true) {
            var _p8 = A2(consumeFirstTokenMatch,
            tokenizerGrammar,
            remainderString);
            if (_p8.ctor === "Nothing") {
                  return accTokens;
               } else {
                  var _v8 = A2($Basics._op["++"],
                  accTokens,
                  _U.list([_p8._0._0])),
                  _v9 = _p8._0._1;
                  accTokens = _v8;
   ...
   _U.list([A2($ElmTest.test,
           ...
           $Maybe.Just({ctor: "_Tuple2"
                       ,_0: {ctor: "_Tuple2",_0: ExclamationMark,_1: "!"}
                       ,_1: "hello"}),
           A2(consumeToken,
           {ctor: "_Tuple2",_0: ExclamationMark,_1: "!"},
           "!hello")))
           ,A2($ElmTest.test,
           "consumeWhitespace",
           A2($ElmTest.assertEqual,
           $Maybe.Just({ctor: "_Tuple2"
                       ,_0: {ctor: "_Tuple2",_0: Whitespace,_1: "   "}
                       ,_1: "hello"}),
           A2(consumeToken,
           {ctor: "_Tuple2",_0: Whitespace,_1: "(\\s)+"},
           "   hello")))
           ,A2($ElmTest.test,
           "consumeFirstTokenMatch (!)",
           A2($ElmTest.assertEqual,
           $Maybe.Just({ctor: "_Tuple2"
                       ,_0: {ctor: "_Tuple2",_0: OpeningComment,_1: "<!--"}
                       ,_1: " hello"}),
           A2(consumeFirstTokenMatch,tokenizerGrammar,"<!-- hello")))
           ,A2($ElmTest.test,
           "consumeWhitespace",
           A2($ElmTest.assertEqual,
           $Maybe.Just({ctor: "_Tuple2"
           ...
           A2($ElmTest.assertEqual,
           $Maybe.Just({ctor: "_Tuple2"
                       ,_0: {ctor: "_Tuple2",_0: Word,_1: "one"}
                       ,_1: ">two"}),
           A2(consumeFirstTokenMatch,tokenizerGrammar,"one>two")))]));
   var main = $ElmTest.elementRunner(tests);
   return _elm.Parser.Tokenizer.values = {_op: _op
                                         ...
                                         ,Word: Word
                                         ,reservedCharTokenLookup: reservedCharTokenLookup
                                         ,specialSequences: specialSequences
                                         ,wordRegex: wordRegex
                                         ,wildcards: wildcards
                                         ,tokenizerGrammar: tokenizerGrammar
                                         ,consumeToken: consumeToken
                                         ,consumeFirstTokenMatch: consumeFirstTokenMatch
                                         ,tokenize: tokenize
                                         ,tests: tests
                                         ,main: main};
};
Elm.Parser = Elm.Parser || {};
Elm.Parser.Parser = Elm.Parser.Parser || {};
Elm.Parser.Parser.make = function (_elm) {
   "use strict";
   _elm.Parser = _elm.Parser || {};
   _elm.Parser.Parser = _elm.Parser.Parser || {};
   if (_elm.Parser.Parser.values) return _elm.Parser.Parser.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $ElmTest = Elm.ElmTest.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Parser$Tokenizer = Elm.Parser.Tokenizer.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var testTokens = _U.list([{ctor: "_Tuple2"
                             ,_0: $Parser$Tokenizer.LeftAngleBracket
                             ,_1: "<"}]);
   var ParseDoesNotMatch = {ctor: "ParseDoesNotMatch"};
   var ParseMatchesReturnsNothing = {ctor: "ParseMatchesReturnsNothing"};
   var ignore = function (parseFunction) {
      var f = function (tokens) {
         var _p0 = parseFunction(tokens);
         if (_p0.ctor === "_Tuple2" && _p0._0.ctor === "ParseMatchesReturnsResult")
         {
               return {ctor: "_Tuple2"
                      ,_0: ParseMatchesReturnsNothing
                      ,_1: _p0._1};
            } else {
               return _p0;
            }
   ...
   var optional = function (parseFunction) {
      var f = function (tokens) {
         var _p1 = parseFunction(tokens);
         if (_p1.ctor === "_Tuple2" && _p1._0.ctor === "ParseDoesNotMatch")
         {
               return {ctor: "_Tuple2"
                      ,_0: ParseMatchesReturnsNothing
                      ,_1: _p1._1};
   ...
   var ParseMatchesReturnsResult = function (a) {
      return {ctor: "ParseMatchesReturnsResult",_0: a};
   };
   var createParseAnyFunction = function (parseFunctions) {
      var parseAny = F2(function (parseFunctions,tokens) {
         parseAny: while (true) {
            var _p2 = parseFunctions;
            if (_p2.ctor === "[]") {
                  return {ctor: "_Tuple2",_0: ParseDoesNotMatch,_1: tokens};
               } else {
                  var _p3 = _p2._0(tokens);
                  switch (_p3._0.ctor)
                  {case "ParseDoesNotMatch": var _v4 = _p2._1,_v5 = tokens;
                       parseFunctions = _v4;
                       tokens = _v5;
                       continue parseAny;
                     case "ParseMatchesReturnsNothing": return {ctor: "_Tuple2"
                                                               ,_0: ParseMatchesReturnsNothing
                                                               ,_1: _p3._1};
                     default: return {ctor: "_Tuple2"
                                     ,_0: ParseMatchesReturnsResult(_p3._0._0)
                                     ,_1: _p3._1};}
               }
         }
      });
   ...
   var TokenDoesNotMatch = function (a) {
      return {ctor: "TokenDoesNotMatch",_0: a};
   };
   var TokenMatches = function (a) {
      return {ctor: "TokenMatches",_0: a};
   };
   var consumeToken = F2(function (expectedTokenType,tokens) {
      var _p4 = tokens;
      if (_p4.ctor === "::") {
            return _U.eq(_p4._0._0,
            expectedTokenType) ? TokenMatches({ctor: "_Tuple2"
                                              ,_0: _p4._0._1
                                              ,_1: _p4._1}) : TokenDoesNotMatch(tokens);
         } else {
            return TokenDoesNotMatch(tokens);
         }
   });
   var createParseTokenIgnoreFunction = function (tokenType) {
      var parseTokenIgnore = function (tokens) {
         var _p5 = A2(consumeToken,tokenType,tokens);
         if (_p5.ctor === "TokenMatches") {
               return {ctor: "_Tuple2"
                      ,_0: ParseMatchesReturnsNothing
                      ,_1: _p5._0._1};
            } else {
   ...
   var parseLeftAngleBracket = createParseTokenIgnoreFunction($Parser$Tokenizer.LeftAngleBracket);
   var parseRightAngleBracket = createParseTokenIgnoreFunction($Parser$Tokenizer.RightAngleBracket);
   var parseRightAngleBracketKeep = createParseTokenIgnoreFunction($Parser$Tokenizer.RightAngleBracket);
   var AstChildren = function (a) {
      return {ctor: "AstChildren",_0: a};
   };
   var AstLeaf = function (a) {
      return {ctor: "AstLeaf",_0: a};
   };
   var AstNodeRecord = F2(function (a,b) {
      return {label: a,value: b};
   });
   var UnlabelledAstNode = function (a) {
      return {ctor: "UnlabelledAstNode",_0: a};
   };
   var createParseTokenKeepFunction = function (tokenType) {
      var parseTokenKeep = function (tokens) {
         var _p6 = A2(consumeToken,tokenType,tokens);
         if (_p6.ctor === "TokenMatches") {
               return {ctor: "_Tuple2"
                      ,_0: ParseMatchesReturnsResult(UnlabelledAstNode(AstLeaf(_p6._0._0)))
                      ,_1: _p6._0._1};
            } else {
               return {ctor: "_Tuple2",_0: ParseDoesNotMatch,_1: tokens};
            }
   ...
   var parseLeftAngleBracketKeep = createParseTokenKeepFunction($Parser$Tokenizer.LeftAngleBracket);
   var parseWordKeep = createParseTokenKeepFunction($Parser$Tokenizer.Word);
   var createOptionallyParseMultipleFunction = function (repeatedParseFunction) {
      var parseMultiple$$ = F2(function (accAstNodes,
      remainderTokens) {
         parseMultiple$$: while (true) {
            var _p7 = repeatedParseFunction(remainderTokens);
            switch (_p7._0.ctor)
            {case "ParseMatchesReturnsResult":
               var _v10 = A2($Basics._op["++"],
                 accAstNodes,
                 _U.list([_p7._0._0])),
                 _v11 = _p7._1;
                 accAstNodes = _v10;
                 remainderTokens = _v11;
                 continue parseMultiple$$;
               case "ParseMatchesReturnsNothing": var _v12 = accAstNodes,
                 _v13 = _p7._1;
                 accAstNodes = _v12;
                 remainderTokens = _v13;
                 continue parseMultiple$$;
               default: return {ctor: "_Tuple2",_0: accAstNodes,_1: _p7._1};}
         }
      });
      var parseMultiple$ = function (tokens) {
         ...
         if (_p8.ctor === "[]") {
               return {ctor: "_Tuple2"
                      ,_0: ParseMatchesReturnsResult(UnlabelledAstNode(AstChildren(_U.list([]))))
                      ,_1: tokens};
            } else {
               var _p9 = A2(parseMultiple$$,_U.list([]),tokens);
               var astNodes = _p9._0;
               var remainderTokens = _p9._1;
               return {ctor: "_Tuple2"
                      ,_0: ParseMatchesReturnsResult(UnlabelledAstNode(AstChildren(astNodes)))
                      ,_1: remainderTokens};
            }
      };
      return parseMultiple$;
   };
   var createParseSequenceFunction = function (parseFunctions) {
      var parseSequence = function (tokens) {
         var parseSequence$ = F3(function (remainderParseFunctions,
         accAstNodes,
         remainderTokens) {
            parseSequence$: while (true) {
               var _p10 = remainderParseFunctions;
               if (_p10.ctor === "[]") {
                     return {ctor: "_Tuple2"
                            ,_0: ParseMatchesReturnsResult(UnlabelledAstNode(AstChildren(accAstNodes)))
                            ,_1: remainderTokens};
                  } else {
                     var _p12 = _p10._1;
                     var _p11 = _p10._0(remainderTokens);
                     switch (_p11._0.ctor)
                     {case "ParseMatchesReturnsNothing": var _v17 = _p12,
                          _v18 = accAstNodes,
                          _v19 = _p11._1;
                          remainderParseFunctions = _v17;
                          accAstNodes = _v18;
                          remainderTokens = _v19;
                          continue parseSequence$;
                        case "ParseMatchesReturnsResult": var _v20 = _p12,
                          _v21 = A2($Basics._op["++"],accAstNodes,_U.list([_p11._0._0])),
                          _v22 = _p11._1;
                          remainderParseFunctions = _v20;
                          accAstNodes = _v21;
                          remainderTokens = _v22;
                          continue parseSequence$;
                        default: return {ctor: "_Tuple2"
                                        ,_0: ParseDoesNotMatch
                                        ,_1: tokens};}
                  }
            }
         });
         ...
         if (_p13.ctor === "[]") {
               ...
               return A3(parseSequence$,parseFunctions,_U.list([]),tokens);
            }
      };
      return parseSequence;
   };
   var createParseAtLeastOneFunction = function (parseFunction) {
      var cleanUpMessyResult = function (messyResult) {
         var _p14 = messyResult;
         if (_p14.ctor === "ParseMatchesReturnsResult") {
               var split$ = function (children) {
                  var _p15 = children;
                  if (_p15.ctor === "::" && _p15._1.ctor === "::") {
                        return {ctor: "_Tuple2",_0: _p15._0,_1: _p15._1._0};
                     } else {
                        return _U.crashCase("Parser.Parser",
                        {start: {line: 276,column: 29},end: {line: 280,column: 52}},
                        _p15)("");
                     }
               };
               var getChildren = function (node) {
                  var _p17 = node;
                  if (_p17.ctor === "UnlabelledAstNode") {
                        var _p18 = _p17._0;
                        if (_p18.ctor === "AstChildren") {
                              return _p18._0;
                           } else {
                              return _U.crashCase("Parser.Parser",
                              {start: {line: 267,column: 37},end: {line: 271,column: 60}},
                              _p18)("");
                           }
                     } else {
                        return _U.crashCase("Parser.Parser",
                        {start: {line: 265,column: 29},end: {line: 274,column: 52}},
                        _p17)("");
                     }
               };
               var _p21 = split$(getChildren(_p14._0));
               var headNode = _p21._0;
               var tailMess = _p21._1;
               var tailNodes = getChildren(tailMess);
               var allNodes = A2($Basics._op["++"],
               _U.list([headNode]),
               tailNodes);
               return ParseMatchesReturnsResult(UnlabelledAstNode(AstChildren(allNodes)));
            } else {
               return messyResult;
            }
      };
      var sequenceFunction = createParseSequenceFunction(_U.list([parseFunction
                                                                 ,createOptionallyParseMultipleFunction(parseFunction)]));
      var parseAtLeastOne$ = function (tokens) {
         return sequenceFunction(tokens);
      };
      var parseAtLeastOne = function (tokens) {
         var _p22 = parseAtLeastOne$(tokens);
         var messyResult = _p22._0;
         var remainderTokens = _p22._1;
         return {ctor: "_Tuple2"
   ...
   var LabelledAstNode = function (a) {
      return {ctor: "LabelledAstNode",_0: a};
   };
   var labelled = F2(function (label,parseFunction) {
      var parseFunction$ = function (tokens) {
         var result = parseFunction(tokens);
         var _p23 = result;
         if (_p23.ctor === "_Tuple2" && _p23._0.ctor === "ParseMatchesReturnsResult" && _p23._0._0.ctor === "UnlabelledAstNode")
         {
               return {ctor: "_Tuple2"
                      ,_0: ParseMatchesReturnsResult(LabelledAstNode({label: label
                                                                     ,value: _p23._0._0._0}))
                      ,_1: _p23._1};
            } else {
               return result;
   ...
   _U.list([A2($ElmTest.test,
           ...
           A2($ElmTest.assertEqual,
           A2(consumeToken,$Parser$Tokenizer.LeftAngleBracket,testTokens),
           TokenMatches({ctor: "_Tuple2",_0: "<",_1: _U.list([])})))
           ,A2($ElmTest.test,
           "consumeToken with match",
           A2($ElmTest.assertEqual,
           A2(consumeToken,$Parser$Tokenizer.LeftAngleBracket,testTokens),
           ...
           A2($ElmTest.assertEqual,
           A2(consumeToken,$Parser$Tokenizer.RightAngleBracket,testTokens),
           ...
           ,_0: ParseMatchesReturnsNothing
           ,_1: _U.list([])},
           A2(createParseTokenIgnoreFunction,
           $Parser$Tokenizer.LeftAngleBracket,
           $Parser$Tokenizer.tokenize("<"))))
           ,A2($ElmTest.test,
           "createParseTokenKeepFunction",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: ParseMatchesReturnsResult(UnlabelledAstNode(AstLeaf("<")))
           ,_1: _U.list([])},
           A2(createParseTokenKeepFunction,
           $Parser$Tokenizer.LeftAngleBracket,
           $Parser$Tokenizer.tokenize("<"))))
           ,A2($ElmTest.test,
           "createParseTokenKeepFunction",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: ParseMatchesReturnsResult(LabelledAstNode({label: "LEFT_ANGLE_BRACKET"
                                                          ,value: AstLeaf("<")}))
           ,_1: _U.list([])},
           function () {
              var parseBracket = A2(labelled,
              "LEFT_ANGLE_BRACKET",
              createParseTokenKeepFunction($Parser$Tokenizer.LeftAngleBracket));
              return parseBracket($Parser$Tokenizer.tokenize("<"));
           }()))
           ,A2($ElmTest.test,
           ...
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: ParseMatchesReturnsResult(UnlabelledAstNode(AstLeaf("h1")))
           ,_1: _U.list([])},
           parseWordKeep($Parser$Tokenizer.tokenize("h1"))))
           ,A2($ElmTest.suite,
           "optionallyParseMultiple",
           function () {
              var optionallyParseMultipleLeftBrackets = createOptionallyParseMultipleFunction(parseLeftAngleBracketKeep);
              return _U.list([A2($ElmTest.test,
                             "optionallyParseMultiple",
                             A2($ElmTest.assertEqual,
                             {ctor: "_Tuple2"
                             ,_0: ParseMatchesReturnsResult(UnlabelledAstNode(AstChildren(_U.list([UnlabelledAstNode(AstLeaf("<"))
                                                                                                  ,UnlabelledAstNode(AstLeaf("<"))]))))
                             ,_1: _U.list([])},
                             optionallyParseMultipleLeftBrackets(_U.list([{ctor: "_Tuple2"
                                                                          ,_0: $Parser$Tokenizer.LeftAngleBracket
                                                                          ,_1: "<"}
                                                                         ,{ctor: "_Tuple2"
                                                                          ,_0: $Parser$Tokenizer.LeftAngleBracket
                             ...
                             ,_1: _U.list([{ctor: "_Tuple2"
                                           ,_0: $Parser$Tokenizer.Word
                                           ,_1: "hello"}])},
                             optionallyParseMultipleLeftBrackets(_U.list([{ctor: "_Tuple2"
                                                                          ,_0: $Parser$Tokenizer.LeftAngleBracket
                                                                          ,_1: "<"}
                                                                         ,{ctor: "_Tuple2",_0: $Parser$Tokenizer.Word,_1: "hello"}]))))
                             ,A2($ElmTest.test,
                             "optionallyParseMultiple",
                             A2($ElmTest.assertEqual,
                             {ctor: "_Tuple2"
                             ...
                             ,_1: _U.list([{ctor: "_Tuple2"
                                           ,_0: $Parser$Tokenizer.Word
                                           ,_1: "hello"}])},
                             optionallyParseMultipleLeftBrackets($Parser$Tokenizer.tokenize("hello"))))]);
           }())
           ,A2($ElmTest.suite,
           "parseAny",
           function () {
              var parseLeftOrRightBracket = createParseAnyFunction(_U.list([parseLeftAngleBracket
              ...
              return _U.list([A2($ElmTest.test,
                             ...
                             ,_0: ParseMatchesReturnsNothing
                             ,_1: _U.list([])},
                             parseLeftOrRightBracket($Parser$Tokenizer.tokenize("<"))))
                             ,A2($ElmTest.test,
                             "parseAny right",
                             A2($ElmTest.assertEqual,
                             {ctor: "_Tuple2"
           ...
           "parseSequence",
           function () {
              var parseSimpleTag = createParseSequenceFunction(_U.list([parseLeftAngleBracket
                                                                       ,parseWordKeep
                                                                       ,parseRightAngleBracket]));
              return _U.list([A2($ElmTest.test,
                             "parseSequence",
                             A2($ElmTest.assertEqual,
                             {ctor: "_Tuple2"
                             ,_0: ParseMatchesReturnsResult(UnlabelledAstNode(AstChildren(_U.list([UnlabelledAstNode(AstLeaf("h1"))]))))
                             ,_1: _U.list([])},
                             parseSimpleTag($Parser$Tokenizer.tokenize("<h1>"))))
                             ,A2($ElmTest.test,
                             "parseSequence",
                             A2($ElmTest.assertEqual,
                             {ctor: "_Tuple2"
                             ...
                             ,_1: _U.list([{ctor: "_Tuple2"
                                           ...
                                           ,_1: "<"}
                                          ,{ctor: "_Tuple2"
                                           ,_0: $Parser$Tokenizer.RightAngleBracket
                                           ,_1: ">"}])},
                             parseSimpleTag($Parser$Tokenizer.tokenize("<>"))))
                             ,A2($ElmTest.test,
                             "parseSequence",
                             function () {
                                var optionalMiddle = createParseSequenceFunction(_U.list([parseLeftAngleBracket
                                ...
                                ,_0: ParseMatchesReturnsResult(UnlabelledAstNode(AstChildren(_U.list([]))))
                                ,_1: _U.list([])},
                                optionalMiddle($Parser$Tokenizer.tokenize("<>")));
                             }())]);
           }())
           ,A2($ElmTest.suite,
           "parseAtLeastOne",
           function () {
              var parseLeftOrRightBracket = createParseAnyFunction(_U.list([parseLeftAngleBracketKeep
                                                                           ,parseRightAngleBracketKeep]));
              var parseAtLeastOneLeftOrRightBracket = createParseAtLeastOneFunction(parseLeftOrRightBracket);
              return _U.list([A2($ElmTest.test,
                             "parseAtLeastOne",
                             A2($ElmTest.assertEqual,
                             {ctor: "_Tuple2"
                             ...
                             ,_1: _U.list([{ctor: "_Tuple2"
                                           ,_0: $Parser$Tokenizer.RightAngleBracket
                                           ,_1: ">"}])},
                             A2(createParseAtLeastOneFunction,
                             ...
                             ,_1: _U.list([{ctor: "_Tuple2"
                                           ,_0: $Parser$Tokenizer.Word
                                           ,_1: "!"}])},
                             parseAtLeastOneLeftOrRightBracket(_U.list([{ctor: "_Tuple2"
                                                                        ,_0: $Parser$Tokenizer.LeftAngleBracket
                                                                        ,_1: "<"}
                                                                       ,{ctor: "_Tuple2"
                                                                        ,_0: $Parser$Tokenizer.LeftAngleBracket
                                                                        ,_1: ">"}
                                                                       ,{ctor: "_Tuple2",_0: $Parser$Tokenizer.Word,_1: "!"}]))))
                             ,A2($ElmTest.test,
                             "parseAtLeastOne",
                             A2($ElmTest.assertEqual,
                             {ctor: "_Tuple2"
   ...
   var main = $ElmTest.elementRunner(tests);
   return _elm.Parser.Parser.values = {_op: _op
                                      ,createParseTokenIgnoreFunction: createParseTokenIgnoreFunction
                                      ,createParseTokenKeepFunction: createParseTokenKeepFunction
                                      ,createParseSequenceFunction: createParseSequenceFunction
                                      ,createOptionallyParseMultipleFunction: createOptionallyParseMultipleFunction
                                      ,createParseAtLeastOneFunction: createParseAtLeastOneFunction
                                      ,createParseAnyFunction: createParseAnyFunction
                                      ,labelled: labelled
                                      ,optional: optional
                                      ,ignore: ignore
                                      ,main: main
                                      ,tests: tests
                                      ,ParseMatchesReturnsResult: ParseMatchesReturnsResult
                                      ,ParseMatchesReturnsNothing: ParseMatchesReturnsNothing
                                      ,ParseDoesNotMatch: ParseDoesNotMatch
                                      ,LabelledAstNode: LabelledAstNode
                                      ,UnlabelledAstNode: UnlabelledAstNode
                                      ,AstLeaf: AstLeaf
                                      ,AstChildren: AstChildren};
};
Elm.Parser = Elm.Parser || {};
Elm.Parser.ParserHelpers = Elm.Parser.ParserHelpers || {};
Elm.Parser.ParserHelpers.make = function (_elm) {
   "use strict";
   _elm.Parser = _elm.Parser || {};
   _elm.Parser.ParserHelpers = _elm.Parser.ParserHelpers || {};
   if (_elm.Parser.ParserHelpers.values)
   return _elm.Parser.ParserHelpers.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $ElmTest = Elm.ElmTest.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Parser$Parser = Elm.Parser.Parser.make(_elm),
   $Parser$Tokenizer = Elm.Parser.Tokenizer.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var leafNodes = _U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("hello"))
                           ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf(" "))
                           ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("world"))]);
   var unlabelledLeafs = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(leafNodes));
   var flattenAstNode = function (astNode) {
      var flatten$ = function (astNode) {
         var _p0 = astNode;
         if (_p0.ctor === "UnlabelledAstNode") {
               var _p1 = _p0._0;
               if (_p1.ctor === "AstLeaf") {
                     return _U.list([astNode]);
                  } else {
                     return A3($List.foldl,flatten$$,_U.list([]),_p1._0);
                  }
            } else {
      ...
      var flatten$$ = F2(function (astNode,acc) {
         return A2($Basics._op["++"],acc,flatten$(astNode));
      });
      var _p3 = astNode;
      if (_p3.ctor === "UnlabelledAstNode") {
            ...
            if (_p4.ctor === "AstLeaf") {
                  ...
                  return $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(flatten$(astNode)));
               }
         } else {
            return _U.crashCase("Parser.ParserHelpers",
   ...
   var flatten = function (parseFunction) {
      var f = function (tokens) {
         var _p6 = parseFunction(tokens);
         if (_p6.ctor === "_Tuple2" && _p6._0.ctor === "ParseMatchesReturnsResult")
         {
               return {ctor: "_Tuple2"
                      ,_0: $Parser$Parser.ParseMatchesReturnsResult(flattenAstNode(_p6._0._0))
                      ,_1: _p6._1};
            } else {
               return _p6;
            }
   ...
   var listToPair = function (xs) {
      return {ctor: "_Tuple2"
             ,_0: unsafeHead(xs)
             ,_1: unsafeHead(unsafeTail(xs))};
   };
   var listTo3Tuple = function (children) {
      return {ctor: "_Tuple3"
             ,_0: unsafeHead(children)
             ,_1: unsafeHead(unsafeTail(children))
             ,_2: unsafeHead(unsafeTail(unsafeTail(children)))};
   };
   var unpackListFromNode = function (astNode) {
      var _p13 = astNode;
      if (_p13.ctor === "UnlabelledAstNode") {
            ...
            if (_p14.ctor === "AstChildren") {
                  ...
                  return _U.list([$Parser$Parser.UnlabelledAstNode(_p15)]);
               }
         } else {
            ...
            if (_p16.ctor === "AstChildren") {
                  ...
                  return _U.list([$Parser$Parser.UnlabelledAstNode(_p17)]);
               }
         }
   };
   var unpackStringFromNode = function (astNode) {
      var _p18 = astNode;
   ...
   var unpackStringsFromNode = function (astNode) {
      var nodes = unpackListFromNode(astNode);
      var strings = A2($List.map,unpackStringFromNode,nodes);
      return strings;
   };
   var concatLeafs = function (astNode) {
      var strings = unpackStringsFromNode(astNode);
      return A3($List.foldr,
      F2(function (x,y) {    return A2($Basics._op["++"],x,y);}),
      "",
      strings);
   ...
   _U.list([A2($ElmTest.test,
           ...
           A2($ElmTest.assertEqual,
           "hello",
           unpackStringFromNode($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("hello")))))
           ,A2($ElmTest.test,
           ...
           listToPair(_U.list([1,2]))))
           ,A2($ElmTest.test,
           "listTo3Tuple",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple3",_0: 1,_1: 2,_2: 3},
           listTo3Tuple(_U.list([1,2,3]))))
           ,A2($ElmTest.test,
           "getLabel",
           A2($ElmTest.assertEqual,
           "SOMETHING",
           getLabel($Parser$Parser.LabelledAstNode({label: "SOMETHING"
                                                   ,value: $Parser$Parser.AstLeaf("hello")}))))
           ,A2($ElmTest.test,
           "flattenAstNode (identity for leaf)",
           A2($ElmTest.assertEqual,
           $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("hello")),
           flattenAstNode($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("hello")))))
           ,A2($ElmTest.test,
           "flattenAstNode (identity for AstChildren)",
           A2($ElmTest.assertEqual,
           $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("hello"))]))),
           flattenAstNode($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("hello"))]))))))
           ,A2($ElmTest.test,
           "flattenAstNode (identity for multiple AstChildren)",
           A2($ElmTest.assertEqual,
           $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("one"))
                                                                               ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("two"))]))),
           flattenAstNode($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("one"))
                                                                                              ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("two"))]))))))
           ,A2($ElmTest.test,
           ...
           $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("one"))
                                                                               ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("two"))
                                                                               ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("three"))]))),
           flattenAstNode($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("one"))])))
   ...
   var parseEqualsSignIgnore = $Parser$Parser.createParseTokenIgnoreFunction($Parser$Tokenizer.EqualsSign);
   var parseForwardSlashIgnore = $Parser$Parser.createParseTokenIgnoreFunction($Parser$Tokenizer.ForwardSlash);
   var parseRightAngleBracketIgnore = $Parser$Parser.createParseTokenIgnoreFunction($Parser$Tokenizer.RightAngleBracket);
   var parseLeftAngleBracketIgnore = $Parser$Parser.createParseTokenIgnoreFunction($Parser$Tokenizer.LeftAngleBracket);
   return _elm.Parser.ParserHelpers.values = {_op: _op
                                             ,parseLeftAngleBracketIgnore: parseLeftAngleBracketIgnore
                                             ,parseRightAngleBracketIgnore: parseRightAngleBracketIgnore
                                             ,parseForwardSlashIgnore: parseForwardSlashIgnore
                                             ...
                                             ,unpackStringsFromNode: unpackStringsFromNode
                                             ,concatLeafs: concatLeafs
                                             ,unsafeHead: unsafeHead
                                             ,unsafeTail: unsafeTail
                                             ,listToPair: listToPair
                                             ,listTo3Tuple: listTo3Tuple
                                             ,getLabel: getLabel
                                             ,flattenAstNode: flattenAstNode
                                             ,flatten: flatten
                                             ,leafNodes: leafNodes
                                             ,unlabelledLeafs: unlabelledLeafs
                                             ,tests: tests
                                             ,main: main};
};
Elm.HtmlParser = Elm.HtmlParser || {};
Elm.HtmlParser.HtmlParserRawAst = Elm.HtmlParser.HtmlParserRawAst || {};
Elm.HtmlParser.HtmlParserRawAst.make = function (_elm) {
   "use strict";
   _elm.HtmlParser = _elm.HtmlParser || {};
   _elm.HtmlParser.HtmlParserRawAst = _elm.HtmlParser.HtmlParserRawAst || {};
   if (_elm.HtmlParser.HtmlParserRawAst.values)
   return _elm.HtmlParser.HtmlParserRawAst.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $ElmTest = Elm.ElmTest.make(_elm),
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Parser$Parser = Elm.Parser.Parser.make(_elm),
   $Parser$ParserHelpers = Elm.Parser.ParserHelpers.make(_elm),
   $Parser$Tokenizer = Elm.Parser.Tokenizer.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var testClosingTagNode = $Parser$Parser.LabelledAstNode({label: "CLOSING_TAG"
                                                           ,value: $Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("div"))]))});
   var testTextNode = $Parser$Parser.LabelledAstNode({label: "TEXT"
                                                     ,value: $Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("one"))
                                                                                                ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf(" "))
                                                                                                ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("two"))]))});
   var attributeId1 = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("id"))])))
                                                                                          ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("1"))])))])));
   var attributeValueSuccessAwesome = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("success"))
                                                                                                          ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf(" "))
                                                                                                          ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("awesome"))])));
   var attributeKeyClass = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("class"))])));
   var attributeSuccessAwesome = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([attributeKeyClass
                                                                                                     ,attributeValueSuccessAwesome])));
   var twoAttributes = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([attributeId1
                                                                                           ,attributeSuccessAwesome])));
   var testOpeningTagNode = $Parser$Parser.LabelledAstNode({label: "OPENING_TAG"
                                                           ,value: $Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("div"))
                                                                                                      ,twoAttributes]))});
   var testSelfClosingTagNode = $Parser$Parser.LabelledAstNode({label: "SELF_CLOSING_TAG"
                                                               ,value: $Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("img"))
                                                                                                          ,twoAttributes]))});
   var parseClosingCommentIgnore = $Parser$Parser.createParseTokenIgnoreFunction($Parser$Tokenizer.ClosingComment);
   var parseOpeningCommentIgnore = $Parser$Parser.createParseTokenIgnoreFunction($Parser$Tokenizer.OpeningComment);
   ...
   var parseClosingTag = A2($Parser$Parser.labelled,
   "CLOSING_TAG",
   $Parser$Parser.createParseSequenceFunction(_U.list([$Parser$ParserHelpers.parseIgnoreOptionalWhitespace
                                                      ,$Parser$ParserHelpers.parseLeftAngleBracketIgnore
                                                      ,$Parser$ParserHelpers.parseForwardSlashIgnore
                                                      ,$Parser$ParserHelpers.parseWordKeep
                                                      ,$Parser$ParserHelpers.parseRightAngleBracketIgnore
                                                      ,$Parser$ParserHelpers.parseIgnoreOptionalWhitespace])));
   ...
   var parseTagAttribute = $Parser$Parser.createParseSequenceFunction(_U.list([$Parser$ParserHelpers.parseIgnoreOptionalWhitespace
                                                                              ...
                                                                              ,$Parser$ParserHelpers.parseIgnoreOptionalWhitespace]));
   var parseTagAttributes = $Parser$Parser.createOptionallyParseMultipleFunction(parseTagAttribute);
   var parseOpeningTag = A2($Parser$Parser.labelled,
   "OPENING_TAG",
   $Parser$Parser.createParseSequenceFunction(_U.list([$Parser$ParserHelpers.parseIgnoreOptionalWhitespace
                                                      ,$Parser$ParserHelpers.parseLeftAngleBracketIgnore
                                                      ,$Parser$ParserHelpers.parseWordKeep
                                                      ...
                                                      ,$Parser$ParserHelpers.parseRightAngleBracketIgnore
                                                      ,$Parser$ParserHelpers.parseIgnoreOptionalWhitespace])));
   var parseSelfClosingTag = A2($Parser$Parser.labelled,
   "SELF_CLOSING_TAG",
   $Parser$Parser.createParseSequenceFunction(_U.list([$Parser$ParserHelpers.parseLeftAngleBracketIgnore
                                                      ,$Parser$ParserHelpers.parseWordKeep
                                                      ,$Parser$ParserHelpers.parseIgnoreOptionalWhitespace
                                                      ,parseTagAttributes
                                                      ,$Parser$ParserHelpers.parseIgnoreOptionalWhitespace
                                                      ,$Parser$ParserHelpers.parseForwardSlashIgnore
                                                      ,$Parser$ParserHelpers.parseRightAngleBracketIgnore])));
   var parseHtmlTokens = $Parser$Parser.createParseAtLeastOneFunction($Parser$Parser.createParseAnyFunction(_U.list([parseOpeningTag
                                                                                                                    ,parseTextNode
                                                                                                                    ,parseClosingTag
                                                                                                                    ,parseSelfClosingTag
                                                                                                                    ,parseComment])));
   var xhtmlToRawAst = function (s) {
      var _p0 = parseHtmlTokens($Parser$Tokenizer.tokenize(s));
      var result = _p0._0;
      return result;
   };
   var tests = A2($ElmTest.suite,
   ...
   _U.list([A2($ElmTest.test,
           ...
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("class"))])))
                                                                                                                             ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("success"))
                                                                                                                                                                                                  ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf(" "))
                                                                                                                                                                                                  ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("awesome"))])))]))))
           ,_1: _U.list([])},
           parseTagAttribute($Parser$Tokenizer.tokenize(" class=\"success awesome\" "))))
           ,A2($ElmTest.test,
           "parse boolean attribute",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("disabled"))])))]))))
           ,_1: _U.list([])},
           parseTagAttribute($Parser$Tokenizer.tokenize(" disabled "))))
           ,A2($ElmTest.test,
           "parseMultipleAttributes",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([attributeId1
                                                                                                                             ,attributeSuccessAwesome]))))
           ,_1: _U.list([])},
           parseTagAttributes($Parser$Tokenizer.tokenize(" id=\"1\" class=\"success awesome\" "))))
           ,A2($ElmTest.test,
           "parsedDashedAttribute",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("data"))
                                                                                                                                                                                                                                                                       ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("-"))
                                                                                                                                                                                                                                                                       ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("name"))])))
                                                                                                                                                                                                  ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("elm"))])))])))]))))
           ,_1: _U.list([])},
           parseTagAttributes($Parser$Tokenizer.tokenize(" data-name=\"elm\" "))))
           ,A2($ElmTest.test,
           "parseClosingTag",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult(testClosingTagNode)
           ,_1: _U.list([])},
           parseClosingTag($Parser$Tokenizer.tokenize("</div>"))))
           ,A2($ElmTest.test,
           "parseOpeningTag no attributes",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult($Parser$Parser.LabelledAstNode({label: "OPENING_TAG"
                                                                                        ,value: $Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("div"))
                                                                                                                                   ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([])))]))}))
           ,_1: _U.list([])},
           parseOpeningTag($Parser$Tokenizer.tokenize("<div >"))))
           ,A2($ElmTest.test,
           "parseOpeningTag one attribute",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult(testOpeningTagNode)
           ,_1: _U.list([])},
           parseOpeningTag($Parser$Tokenizer.tokenize("<div id=\"1\" class=\"success awesome\">"))))
           ,A2($ElmTest.test,
           "parseSelfClosingTag",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult(testSelfClosingTagNode)
           ,_1: _U.list([])},
           parseSelfClosingTag($Parser$Tokenizer.tokenize("<img id=\"1\" class=\"success awesome\" />"))))
           ,A2($ElmTest.test,
           "parseTextNode",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult(testTextNode)
           ,_1: _U.list([])},
           parseTextNode($Parser$Tokenizer.tokenize("one two"))))
           ,A2($ElmTest.test,
           "parseTextNode",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseDoesNotMatch
           ,_1: _U.list([{ctor: "_Tuple2"
                         ,_0: $Parser$Tokenizer.LeftAngleBracket
                         ,_1: "<"}])},
           parseTextNode($Parser$Tokenizer.tokenize("<"))))
           ,A2($ElmTest.test,
           "parseTextNode",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult($Parser$Parser.LabelledAstNode({label: "TEXT"
                                                                                        ,value: $Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf(" "))]))}))
           ,_1: _U.list([{ctor: "_Tuple2"
                         ,_0: $Parser$Tokenizer.LeftAngleBracket
                         ,_1: "<"}])},
           parseTextNode(_U.list([{ctor: "_Tuple2"
                                  ,_0: $Parser$Tokenizer.Whitespace
                                  ,_1: " "}
                                 ,{ctor: "_Tuple2"
                                  ,_0: $Parser$Tokenizer.LeftAngleBracket
                                  ,_1: "<"}]))))
           ...
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsResult($Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([testOpeningTagNode
                                                                                                                             ,testTextNode
                                                                                                                             ,testClosingTagNode
                                                                                                                             ,testClosingTagNode
                                                                                                                             ,testTextNode
                                                                                                                             ,testOpeningTagNode]))))
           ,_1: _U.list([])},
           parseHtmlTokens($Parser$Tokenizer.tokenize(" <div id=\"1\" class=\"success awesome\" >one two</div></div>one two<div id=\"1\" class=\"success awesome\" > "))))
           ,A2($ElmTest.test,
           "parseComment",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseMatchesReturnsNothing
           ,_1: _U.list([])},
           parseComment($Parser$Tokenizer.tokenize("<!--hello world-->"))))
           ,A2($ElmTest.test,
           "parse empty string",
           A2($ElmTest.assertEqual,
           {ctor: "_Tuple2"
           ,_0: $Parser$Parser.ParseDoesNotMatch
           ,_1: _U.list([])},
           parseHtmlTokens($Parser$Tokenizer.tokenize(""))))]));
   var main = $ElmTest.elementRunner(tests);
   return _elm.HtmlParser.HtmlParserRawAst.values = {_op: _op
                                                    ,xhtmlToRawAst: xhtmlToRawAst
                                                    ,main: main
                                                    ,tests: tests};
};
Elm.HtmlParser = Elm.HtmlParser || {};
Elm.HtmlParser.HtmlParser = Elm.HtmlParser.HtmlParser || {};
Elm.HtmlParser.HtmlParser.make = function (_elm) {
   "use strict";
   _elm.HtmlParser = _elm.HtmlParser || {};
   _elm.HtmlParser.HtmlParser = _elm.HtmlParser.HtmlParser || {};
   if (_elm.HtmlParser.HtmlParser.values)
   return _elm.HtmlParser.HtmlParser.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $ElmTest = Elm.ElmTest.make(_elm),
   $HtmlParser$HtmlParserRawAst = Elm.HtmlParser.HtmlParserRawAst.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Parser$Parser = Elm.Parser.Parser.make(_elm),
   $Parser$ParserHelpers = Elm.Parser.ParserHelpers.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var simpleHtmlResult = $HtmlParser$HtmlParserRawAst.xhtmlToRawAst("<h1>hello world</h1>");
   var assumeSuccess = function (x) {
      var _p0 = x;
      if (_p0.ctor === "Just") {
            return _p0._0;
         } else {
   ...
   var assumeParseSuccess = function (parseResult) {
      var _p2 = parseResult;
   ...
   var simpleHtmlAstNode = assumeParseSuccess(simpleHtmlResult);
   var nestedHtmlAstNode = assumeParseSuccess($HtmlParser$HtmlParserRawAst.xhtmlToRawAst("<div><h1>hello world</h1></div>"));
   var testAttribute3 = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("data"))
                                                                                                                                                                 ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("-"))
                                                                                                                                                                 ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("name"))])))
                                                                                            ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("elm"))])))])));
   var testAttributes2 = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([testAttribute3])));
   var testAttribute2 = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("id"))])))
                                                                                            ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("1"))])))])));
   var testAttribute1 = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("class"))])))
                                                                                            ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("success"))
                                                                                                                                                                 ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf(" "))
                                                                                                                                                                 ,$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("awesome"))])))])));
   var testAttributes = $Parser$Parser.UnlabelledAstNode($Parser$Parser.AstChildren(_U.list([testAttribute1
                                                                                            ,testAttribute2])));
   var testOpeningTag = $Parser$Parser.LabelledAstNode({label: "OPENING_TAG"
                                                       ,value: $Parser$Parser.AstChildren(_U.list([$Parser$Parser.UnlabelledAstNode($Parser$Parser.AstLeaf("div"))
                                                                                                  ,testAttributes]))});
   var getTagName = function (astNode) {
      var _p4 = $Parser$ParserHelpers.listToPair($Parser$ParserHelpers.unpackListFromNode(astNode));
      var tagNameNode = _p4._0;
      var attributesNode = _p4._1;
      return $Parser$ParserHelpers.unpackStringFromNode(tagNameNode);
   };
   var attributeToTuple = function (astNode) {
      var strings = $Parser$ParserHelpers.unpackStringsFromNode(astNode);
      return _U.eq($List.length(strings),
      1) ? $Parser$ParserHelpers.listToPair(A2($Basics._op["++"],
      strings,
      _U.list([""]))) : $Parser$ParserHelpers.listToPair(strings);
   };
   var attributesToDict = function (astNode) {
      var attributes = A2($List.map,
      attributeToTuple,
      $Parser$ParserHelpers.unpackListFromNode(astNode));
      return $Dict.fromList(attributes);
   };
   var voidElements = _U.list(["area"
                              ,"base"
                              ,"br"
                              ,"col"
                              ,"embed"
                              ...
                              ,"track"
                              ,"wbr"]);
   var TextAstNode = {ctor: "TextAstNode"};
   var SelfClosingTagAstNode = {ctor: "SelfClosingTagAstNode"};
   var ClosingTagAstNode = {ctor: "ClosingTagAstNode"};
   var OpeningTagAstNode = {ctor: "OpeningTagAstNode"};
   var astNodeTypeLookup = $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                   ,_0: "OPENING_TAG"
                                                   ,_1: OpeningTagAstNode}
                                                  ,{ctor: "_Tuple2",_0: "CLOSING_TAG",_1: ClosingTagAstNode}
                                                  ,{ctor: "_Tuple2",_0: "TEXT",_1: TextAstNode}
                                                  ,{ctor: "_Tuple2"
                                                   ,_0: "SELF_CLOSING_TAG"
                                                   ,_1: SelfClosingTagAstNode}]));
   var getAstNodeType = function (astNode) {
      var label = $Parser$ParserHelpers.getLabel(astNode);
   ...
   var convertTextNode = function (astNode) {
      return Text($Parser$ParserHelpers.concatLeafs(astNode));
   };
   var convertAttributeValue = function (astNode) {
      return Text($Parser$ParserHelpers.concatLeafs(astNode));
   };
   var Element = function (a) {
      return {ctor: "Element",_0: a};
   };
   var convertOpeningTag = function (astNode) {
      var _p9 = $Parser$ParserHelpers.listToPair($Parser$ParserHelpers.unpackListFromNode(astNode));
      var tagNameNode = _p9._0;
      var attributesNode = _p9._1;
      return Element({tagName: $Parser$ParserHelpers.unpackStringFromNode(tagNameNode)
                     ,attributes: attributesToDict(attributesNode)
                     ,children: _U.list([])});
   };
   var convertSelfClosingTag = convertOpeningTag;
   var appendNode = F2(function (node,childNode) {
      var _p10 = node;
      if (_p10.ctor === "Element") {
            var _p11 = _p10._0;
            return Element(_U.update(_p11,
            {children: A2($Basics._op["++"],
            _p11.children,
            _U.list([childNode]))}));
         } else {
            return node;
   ...
   var flatAstToTree = F2(function (openingTagAstNode,astNodes) {
      var flatAstToTree$ = F2(function (currNode,
      remainderAstNodes) {
         flatAstToTree$: while (true) {
            var _p12 = remainderAstNodes;
            if (_p12.ctor === "[]") {
                  return {ctor: "_Tuple2",_0: currNode,_1: _U.list([])};
               } else {
                  var _p16 = _p12._1;
                  var _p15 = _p12._0;
                  var _p13 = getAstNodeType(_p15);
                  switch (_p13.ctor)
                  {case "TextAstNode": var newNode = A2(appendNode,
                       currNode,
                       convertTextNode(_p15));
                       var _v7 = newNode,_v8 = _p16;
                       currNode = _v7;
                       remainderAstNodes = _v8;
                       continue flatAstToTree$;
                     case "OpeningTagAstNode": var _p14 = A2(flatAstToTree,
                       _p15,
                       _p16);
                       var elementNode = _p14._0;
                       var remainderAstNodes$ = _p14._1;
                       var newNode = A2(appendNode,currNode,elementNode);
                       var _v9 = newNode,_v10 = remainderAstNodes$;
                       currNode = _v9;
                       remainderAstNodes = _v10;
                       continue flatAstToTree$;
                     case "ClosingTagAstNode": return {ctor: "_Tuple2"
                                                      ,_0: currNode
                                                      ,_1: _p16};
                     default: var newNode = A2(appendNode,
                       currNode,
                       convertSelfClosingTag(_p15));
                       var _v11 = newNode,_v12 = _p16;
                       currNode = _v11;
      ...
      var initialNode = convertOpeningTag(openingTagAstNode);
      var result = A2(flatAstToTree$,initialNode,astNodes);
      return result;
   });
   var astNodeToHtmlNode = function (astNode) {
      var astNodes = $Parser$ParserHelpers.unpackListFromNode(astNode);
      var headNode = $Parser$ParserHelpers.unsafeHead(astNodes);
      var tailNodes = $Parser$ParserHelpers.unsafeTail(astNodes);
      var _p17 = astNodes;
      if (_p17.ctor === "[]") {
            return $Maybe.Nothing;
         } else {
            var _p20 = _p17._0;
            var _p18 = getAstNodeType(_p20);
            if (_p18.ctor === "OpeningTagAstNode") {
                  var _p19 = A2(flatAstToTree,_p20,_p17._1);
                  var node = _p19._0;
   ...
   var parseHtml = function (s) {
      var result = $HtmlParser$HtmlParserRawAst.xhtmlToRawAst(s);
      var _p21 = $HtmlParser$HtmlParserRawAst.xhtmlToRawAst(s);
      switch (_p21.ctor)
      {case "ParseDoesNotMatch": return $Maybe.Nothing;
         case "ParseMatchesReturnsResult":
   ...
   _U.list([A2($ElmTest.test,
           ...
           "attributeToTuple",
           A2($ElmTest.assertEqual,
           $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                   ,_0: "class"
                                   ,_1: "success awesome"}
           ...
           A2($ElmTest.assertEqual,
           Element({tagName: "div"
                   ,attributes: $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                        ,_0: "class"
                                                        ,_1: "success awesome"}
                                                       ,{ctor: "_Tuple2",_0: "id",_1: "1"}]))
                   ,children: _U.list([])}),
           ...
           A2($ElmTest.assertEqual,
           Element({tagName: "div"
                   ,attributes: $Dict.fromList(_U.list([]))
                   ,children: _U.list([Text("hello")])}),
           A2(appendNode,
           Element({tagName: "div"
                   ,attributes: $Dict.fromList(_U.list([]))
                   ,children: _U.list([])}),
           ...
           Element({tagName: "h1"
                   ...
                   ,children: _U.list([Text("hello world")])}),
           ...
           Element({tagName: "div"
                   ,attributes: $Dict.empty
                   ,children: _U.list([Element({tagName: "h1"
                                               ,attributes: $Dict.empty
                                               ,children: _U.list([Text("hello world")])})])}),
           ...
           Element({tagName: "div"
                   ,attributes: $Dict.fromList(_U.list([]))
                   ,children: _U.list([Element({tagName: "img"
                                               ,attributes: $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                                                    ,_0: "src"
                                                                                    ,_1: "test.jpg"}]))
                                               ,children: _U.list([])})])}),
           assumeSuccess(astNodeToHtmlNode(assumeParseSuccess($HtmlParser$HtmlParserRawAst.xhtmlToRawAst("<div><img src=\"test.jpg\"/></div>"))))))
           ,A2($ElmTest.test,
           "boolean attribute",
           A2($ElmTest.assertEqual,
           Element({tagName: "div"
                   ,attributes: $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                        ...
                                                        ,_1: ""}]))
                   ,children: _U.list([])}),
           assumeSuccess(astNodeToHtmlNode(assumeParseSuccess($HtmlParser$HtmlParserRawAst.xhtmlToRawAst("<div disabled></div>"))))))]));
   var main = $ElmTest.elementRunner(tests);
   return _elm.HtmlParser.HtmlParser.values = {_op: _op
                                              ,parseHtml: parseHtml
                                              ,main: main
                                              ,tests: tests
                                              ,Element: Element
...
Elm.HtmlToElm = Elm.HtmlToElm || {};
Elm.HtmlToElm.ElmHtmlWhitelists = Elm.HtmlToElm.ElmHtmlWhitelists || {};
Elm.HtmlToElm.ElmHtmlWhitelists.make = function (_elm) {
   "use strict";
   _elm.HtmlToElm = _elm.HtmlToElm || {};
   _elm.HtmlToElm.ElmHtmlWhitelists = _elm.HtmlToElm.ElmHtmlWhitelists || {};
   if (_elm.HtmlToElm.ElmHtmlWhitelists.values)
   return _elm.HtmlToElm.ElmHtmlWhitelists.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
...
Elm.HtmlToElm = Elm.HtmlToElm || {};
Elm.HtmlToElm.HtmlToElm = Elm.HtmlToElm.HtmlToElm || {};
Elm.HtmlToElm.HtmlToElm.make = function (_elm) {
   "use strict";
   _elm.HtmlToElm = _elm.HtmlToElm || {};
   _elm.HtmlToElm.HtmlToElm = _elm.HtmlToElm.HtmlToElm || {};
   if (_elm.HtmlToElm.HtmlToElm.values)
   return _elm.HtmlToElm.HtmlToElm.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $ElmTest = Elm.ElmTest.make(_elm),
   $HtmlParser$HtmlParser = Elm.HtmlParser.HtmlParser.make(_elm),
   $HtmlToElm$ElmHtmlWhitelists = Elm.HtmlToElm.ElmHtmlWhitelists.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Regex = Elm.Regex.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var testAttributes = $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                ,_0: "id"
                                                ,_1: "1"}
                                               ,{ctor: "_Tuple2",_0: "class",_1: "success"}]));
   var testLeafElement = $HtmlParser$HtmlParser.Element({tagName: "div"
                                                        ,attributes: testAttributes
                                                        ,children: _U.list([])});
   var testLeafElements = A2($List.repeat,3,testLeafElement);
   ...
   var flattenIndentTree = function (indentTree) {
      var flattenIndentTree$ = F2(function (indentTree,acc) {
         return A2($Basics._op["++"],
   ...
   var renderTagFunctionHead = function (tagName) {
      return A2($List.member,
      tagName,
      $HtmlToElm$ElmHtmlWhitelists.implementedTagFunctions) ? tagName : A2($List.member,
      tagName,
   ...
   var renderAttributes = function (attributes) {
      ...
      var attributeListString = A2($List.map,
      renderAttribute,
      attributesList);
      ...
      if (_p8 === "") {
            ...
            return A2($Basics._op["++"],
            "[ ",
            A2($Basics._op["++"],innards," ]"));
         }
   };
   var IndentTrees = function (a) {
      return {ctor: "IndentTrees",_0: a};
   };
   var IndentTreeLeaf = function (a) {
      return {ctor: "IndentTreeLeaf",_0: a};
   };
   var indentTreeStrings = F2(function (spacesPerIndent,
   originalTree) {
   ...
   var renderVerticalChild = function (node) {
      ...
      if (_p17.ctor === "Element") {
            ...
            return IndentTreeLeaf(renderTextNode(node));
         }
   };
   var renderNode = function (node) {
      return renderVerticalChild(node);
   };
   var verticallyRenderChildren = function (nodes) {
      return IndentTrees(A2($List.map,renderVerticalChild,nodes));
   };
   var htmlNodeToElm = F2(function (spacesPerIndent,node) {
      return A2($String.join,
      "\n",
      flattenIndentTree(A2(indentTreeStrings,
      spacesPerIndent,
      renderNode(node))));
   });
   ...
   var testIndentTree = IndentTrees(_U.list([IndentTreeLeaf("a")
   ...
   _U.list([A2($ElmTest.test,
           ...
           A2($ElmTest.assertEqual,
           "class \"success\"",
           renderAttribute({ctor: "_Tuple2",_0: "class",_1: "success"})))
           ,A2($ElmTest.test,
           "renderAttributes",
           A2($ElmTest.assertEqual,
           "[ class \"success\", id \"1\" ]",
           renderAttributes($Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                    ,_0: "id"
                                                    ,_1: "1"}
                                                   ,{ctor: "_Tuple2",_0: "class",_1: "success"}])))))
           ,A2($ElmTest.test,
           ...
           A2($ElmTest.assertEqual,
           "[]",
           renderAttributes($Dict.fromList(_U.list([])))))
           ,A2($ElmTest.test,
           "renderTextNode",
           A2($ElmTest.assertEqual,
           "text \"hello\"",
           renderTextNode($HtmlParser$HtmlParser.Text("hello"))))
           ,A2($ElmTest.test,
           "indent",
           A2($ElmTest.assertEqual,"        hello",A3(indent,4,2,"hello")))
           ,A2($ElmTest.test,
           "indentTree",
           A2($ElmTest.assertEqual,
           ...
           A2($ElmTest.assertEqual,
           _U.list([IndentTreeLeaf("[ X")
                   ,IndentTreeLeaf(", X")
                   ,IndentTreeLeaf("]")]),
           formatHaskellMultilineList(_U.list([IndentTreeLeaf("X")
                                              ,IndentTreeLeaf("X")]))))
           ,A2($ElmTest.test,
           "just text",
           A2($ElmTest.assertEqual,
   ...
   var main = $ElmTest.elementRunner(tests);
   return _elm.HtmlToElm.HtmlToElm.values = {_op: _op
                                            ,IndentTreeLeaf: IndentTreeLeaf
                                            ,IndentTrees: IndentTrees
                                            ,renderAttribute: renderAttribute
                                            ,indent: indent
                                            ,renderAttributes: renderAttributes
                                            ,renderTextNode: renderTextNode
                                            ,renderTagFunctionHead: renderTagFunctionHead
                                            ,renderVerticalChild: renderVerticalChild
                                            ,verticallyRenderChildren: verticallyRenderChildren
                                            ,renderNode: renderNode
                                            ,indentTreeStrings: indentTreeStrings
                                            ...
                                            ,testLeafElement: testLeafElement
                                            ,testLeafElement2: testLeafElement2
                                            ,testLeafElements: testLeafElements
                                            ,testIndentTree: testIndentTree
                                            ,tests: tests
                                            ,main: main};
};
Elm.HtmlToElmWebsite = Elm.HtmlToElmWebsite || {};
Elm.HtmlToElmWebsite.HtmlComponents = Elm.HtmlToElmWebsite.HtmlComponents || {};
Elm.HtmlToElmWebsite.HtmlComponents.make = function (_elm) {
   "use strict";
   _elm.HtmlToElmWebsite = _elm.HtmlToElmWebsite || {};
   _elm.HtmlToElmWebsite.HtmlComponents = _elm.HtmlToElmWebsite.HtmlComponents || {};
   if (_elm.HtmlToElmWebsite.HtmlComponents.values)
   return _elm.HtmlToElmWebsite.HtmlComponents.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var githubStarButton = function (params) {
      var iframeHeight = _U.eq(params.size,"small") ? 20 : 30;
      var iframeWidth = _U.eq(params.size,"small") ? 170 : 160;
      ...
      A2($Basics._op["++"],
      params.type$,
      A2($Basics._op["++"],"&count=true&size=",params.size)))))));
      return A2($Html.iframe,
      _U.list([A2($Html$Attributes.attribute,"frameborder","0")
              ,A2($Html$Attributes.attribute,"scrolling","0")
              ,$Html$Attributes.width(iframeWidth)
              ,$Html$Attributes.height(iframeHeight)
              ,$Html$Attributes.src(url)
              ,$Html$Attributes.style(params.style)]),
      _U.list([]));
   };
   var githubForkRibbon = function (url) {
      return A2($Html.a,
      _U.list([$Html$Attributes.href("https://github.com/mbylstra/html-to-elm")]),
      _U.list([A2($Html.img,
      _U.list([$Html$Attributes.alt("Fork me on GitHub")
              ,$Html$Attributes.src("https://camo.githubusercontent.com/365986a132ccd6a44c23a9169022c0b5c890c387/68747470733a2f2f73332e616d617a6f6e6177732e636f6d2f6769746875622f726962626f6e732f666f726b6d655f72696768745f7265645f6161303030302e706e67")
              ,A2($Html$Attributes.attribute,
              "style",
              "position: absolute; top: 0; right: 0; border: 0; z-index: 100")]),
      _U.list([]))]));
   };
   return _elm.HtmlToElmWebsite.HtmlComponents.values = {_op: _op
                                                        ,githubForkRibbon: githubForkRibbon
                                                        ,githubStarButton: githubStarButton};
};
Elm.HtmlToElmWebsite = Elm.HtmlToElmWebsite || {};
Elm.HtmlToElmWebsite.HtmlExamples = Elm.HtmlToElmWebsite.HtmlExamples || {};
Elm.HtmlToElmWebsite.HtmlExamples.make = function (_elm) {
   "use strict";
   _elm.HtmlToElmWebsite = _elm.HtmlToElmWebsite || {};
   _elm.HtmlToElmWebsite.HtmlExamples = _elm.HtmlToElmWebsite.HtmlExamples || {};
   if (_elm.HtmlToElmWebsite.HtmlExamples.values)
   return _elm.HtmlToElmWebsite.HtmlExamples.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var bootstrapNavbar = "<nav class=\"navbar navbar-default\">\n  <div class=\"container-fluid\">\n    <!-- Brand and toggle get grouped for better mobile display -->\n    <div class=\"navbar-header\">\n      <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#bs-example-navbar-collapse-1\" aria-expanded=\"false\">\n        <span class=\"sr-only\">Toggle navigation</span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n      </button>\n      <a class=\"navbar-brand\" href=\"#\">Brand</a>\n    </div>\n\n    <!-- Collect the nav links, forms, and other content for toggling -->\n    <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\">\n      <ul class=\"nav navbar-nav\">\n        <li class=\"active\"><a href=\"#\">Link <span class=\"sr-only\">(current)</span></a></li>\n        <li><a href=\"#\">Link</a></li>\n        <li class=\"dropdown\">\n          <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">Dropdown <span class=\"caret\"></span></a>\n          <ul class=\"dropdown-menu\">\n            <li><a href=\"#\">Action</a></li>\n            <li><a href=\"#\">Another action</a></li>\n            <li><a href=\"#\">Something else here</a></li>\n            <li role=\"separator\" class=\"divider\"></li>\n            <li><a href=\"#\">Separated link</a></li>\n            <li role=\"separator\" class=\"divider\"></li>\n            <li><a href=\"#\">One more separated link</a></li>\n          </ul>\n        </li>\n      </ul>\n      <form class=\"navbar-form navbar-left\" role=\"search\">\n        <div class=\"form-group\">\n          <input type=\"text\" class=\"form-control\" placeholder=\"Search\">\n        </div>\n        <button type=\"submit\" class=\"btn btn-default\">Submit</button>\n      </form>\n      <ul class=\"nav navbar-nav navbar-right\">\n        <li><a href=\"#\">Link</a></li>\n        <li class=\"dropdown\">\n          <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">Dropdown <span class=\"caret\"></span></a>\n          <ul class=\"dropdown-menu\">\n            <li><a href=\"#\">Action</a></li>\n            <li><a href=\"#\">Another action</a></li>\n            <li><a href=\"#\">Something else here</a></li>\n            <li role=\"separator\" class=\"divider\"></li>\n            <li><a href=\"#\">Separated link</a></li>\n          </ul>\n        </li>\n      </ul>\n    </div><!-- /.navbar-collapse -->\n  </div><!-- /.container-fluid -->\n</nav>\n";
   var zurbTopbar = "<div class=\"top-bar\">\n  <div class=\"top-bar-left\">\n    <ul class=\"dropdown menu\" data-dropdown-menu>\n      <li class=\"menu-text\">Site Title</li>\n      <li class=\"has-submenu\">\n        <a href=\"#\">One</a>\n        <ul class=\"submenu menu vertical\" data-submenu>\n          <li><a href=\"#\">One</a></li>\n          <li><a href=\"#\">Two</a></li>\n          <li><a href=\"#\">Three</a></li>\n        </ul>\n      </li>\n      <li><a href=\"#\">Two</a></li>\n      <li><a href=\"#\">Three</a></li>\n    </ul>\n  </div>\n  <div class=\"top-bar-right\">\n    <ul class=\"menu\">\n      <li><input type=\"search\" placeholder=\"Search\"></li>\n      <li><button type=\"button\" class=\"button\">Search</button></li>\n    </ul>\n  </div>\n</div>\n";
   var a = "<a href=\"\">link text</a>\n";
   var ul = "<ul class=\"fruit\">\n    <li>banana</li>\n    <li>apple</li>\n    <li>carrot</li>\n</ul>\n";
   var helloWorld = "<span class=\"welcome-message\">Hello, World</span>\n";
   var htmlExamples = $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                              ,_0: "hello world"
                                              ,_1: helloWorld}
                                             ,{ctor: "_Tuple2",_0: "ul",_1: ul}
                                             ,{ctor: "_Tuple2",_0: "a",_1: a}
                                             ,{ctor: "_Tuple2",_0: "zurb topbar",_1: zurbTopbar}
                                             ,{ctor: "_Tuple2"
                                              ,_0: "bootstrap navbar"
                                              ,_1: bootstrapNavbar}]));
   return _elm.HtmlToElmWebsite.HtmlExamples.values = {_op: _op
                                                      ,htmlExamples: htmlExamples
                                                      ,helloWorld: helloWorld
                                                      ,ul: ul
                                                      ,a: a
                                                      ,zurbTopbar: zurbTopbar
                                                      ,bootstrapNavbar: bootstrapNavbar};
};
Elm.HtmlToElmWebsite = Elm.HtmlToElmWebsite || {};
Elm.HtmlToElmWebsite.Layout = Elm.HtmlToElmWebsite.Layout || {};
Elm.HtmlToElmWebsite.Layout.make = function (_elm) {
   "use strict";
   _elm.HtmlToElmWebsite = _elm.HtmlToElmWebsite || {};
   _elm.HtmlToElmWebsite.Layout = _elm.HtmlToElmWebsite.Layout || {};
   if (_elm.HtmlToElmWebsite.Layout.values)
   return _elm.HtmlToElmWebsite.Layout.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var topBarRight = _U.list([{ctor: "_Tuple2"
                              ,_0: "float"
                              ,_1: "right"}]);
   var panelHeaderHeight = 30;
   var panelHeader = _U.list([{ctor: "_Tuple2"
                              ,_0: "height"
                              ,_1: A2($Basics._op["++"],
                              $Basics.toString(panelHeaderHeight),
                              "px")}]);
   var topBarHeight = 50;
   var topBar = _U.list([{ctor: "_Tuple2"
                         ,_0: "height"
                         ,_1: A2($Basics._op["++"],$Basics.toString(topBarHeight),"px")}
                        ,{ctor: "_Tuple2"
                         ,_0: "line-height"
                         ,_1: A2($Basics._op["++"],$Basics.toString(topBarHeight),"px")}
                        ,{ctor: "_Tuple2"
                         ,_0: "padding-left"
                         ,_1: A2($Basics._op["++"],$Basics.toString(12),"px")}
                        ,{ctor: "_Tuple2"
                         ,_0: "font-size"
                         ,_1: A2($Basics._op["++"],$Basics.toString(20),"px")}
                        ,{ctor: "_Tuple2",_0: "color",_1: "#293c4b"}]);
   var mainPanel = function (_p0) {
      var _p1 = _p0;
      var height = _p1._1 - topBarHeight;
      var width = _p1._0 / 2 | 0;
   ...
   var leftPanel = function (windowDimensions) {
      return A2($Basics._op["++"],
      mainPanel(windowDimensions),
      _U.list([{ctor: "_Tuple2",_0: "left",_1: "0px"}]));
   };
   var rightPanel = function (windowDimensions) {
      return A2($Basics._op["++"],
      mainPanel(windowDimensions),
      _U.list([{ctor: "_Tuple2",_0: "right",_1: "0px"}]));
   };
   var panelContent = function (_p2) {
      var _p3 = _p2;
      var height = _p3._1 - (topBarHeight + panelHeaderHeight * 2);
      return _U.list([{ctor: "_Tuple2"
                      ,_0: "height"
                      ,_1: A2($Basics._op["++"],$Basics.toString(height),"px")}]);
   };
   return _elm.HtmlToElmWebsite.Layout.values = {_op: _op
...
Elm.Main.make = function (_elm) {
   ...
   $HtmlToElm$HtmlToElm = Elm.HtmlToElm.HtmlToElm.make(_elm),
   $HtmlToElmWebsite$HtmlComponents = Elm.HtmlToElmWebsite.HtmlComponents.make(_elm),
   $HtmlToElmWebsite$HtmlExamples = Elm.HtmlToElmWebsite.HtmlExamples.make(_elm),
   $HtmlToElmWebsite$Layout = Elm.HtmlToElmWebsite.Layout.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var _op = {};
   var windowHeight = Elm.Native.Port.make(_elm).outboundSignal("windowHeight",
   function (v) {
      return v;
   },
   $Window.height);
   var incomingHtmlCodeSignal = Elm.Native.Port.make(_elm).inboundSignal("incomingHtmlCodeSignal",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",
      v);
   });
   var initialModel = {html: ""
                      ,elmCode: $Maybe.Just("")
                      ,indentSpaces: 4
                      ,currentSnippet: ""};
   ...
   var updateFunc = F2(function (maybeAction,model) {
      var _p0 = maybeAction;
      if (_p0.ctor === "Just") {
            var _p1 = _p0._0;
            switch (_p1.ctor)
            {case "HtmlUpdated": var _p2 = _p1._0;
                 return _U.update(model,
                 {html: _p2,elmCode: A2($HtmlToElm$HtmlToElm.htmlToElm,4,_p2)});
               case "LoadSnippet": return _U.update(model,
                 {currentSnippet: function () {
                    var _p3 = A2($Dict.get,
                    _p1._0,
                    $HtmlToElmWebsite$HtmlExamples.htmlExamples);
                    if (_p3.ctor === "Just") {
                          return _p3._0;
                       } else {
                          return "";
   ...
   var actionsMailbox = $Signal.mailbox($Maybe.Nothing);
   var actionsAddress = A2($Signal.forwardTo,
   actionsMailbox.address,
   $Maybe.Just);
   var actionsModelSignal = A3($Signal.foldp,
   updateFunc,
   initialModel,
   actionsMailbox.signal);
   var modelSignal = function () {
      var reducer = F2(function (actionsModel,htmlCode) {
         var elmCode = A2($HtmlToElm$HtmlToElm.htmlToElm,
         actionsModel.indentSpaces,
         htmlCode);
         return _U.update(actionsModel,{elmCode: elmCode});
      });
      return A3($Signal.map2,
      reducer,
      actionsModelSignal,
      incomingHtmlCodeSignal);
   }();
   var outgoingElmCode = Elm.Native.Port.make(_elm).outboundSignal("outgoingElmCode",
   function (v) {
   ...
   modelSignal));
   var currentSnippet = Elm.Native.Port.make(_elm).outboundSignal("currentSnippet",
   function (v) {
      return v;
   },
   $Signal.dropRepeats(A2($Signal.map,
   function (_) {
      return _.currentSnippet;
   },
   modelSignal)));
   var HtmlUpdated = function (a) {
      return {ctor: "HtmlUpdated",_0: a};
   };
   var SetIndentSpaces = function (a) {
      return {ctor: "SetIndentSpaces",_0: a};
   };
   var LoadSnippet = function (a) {
      return {ctor: "LoadSnippet",_0: a};
   };
   var copyButton = function (visible) {
      var style$ = visible ? _U.list([]) : _U.list([{ctor: "_Tuple2"
                                                    ,_0: "display"
                                                    ,_1: "none"}]);
      return A2($Html.div,
      _U.list([$Html$Attributes.id("copy-button")
              ,$Html$Attributes.style(style$)
              ,$Html$Attributes.$class("copy-button")]),
      _U.list([$Html.text("copy")]));
   };
   var rightPanel = F3(function (windowDimensions,model,address) {
      var hint = function () {
         var _p5 = model.elmCode;
         if (_p5.ctor === "Just") {
               return A2($Html.div,_U.list([]),_U.list([]));
            } else {
               return A2($Html.div,
               _U.list([$Html$Attributes.$class("hint")]),
               _U.list([$Html.text("\n                            Hint: only one top level element is allowed\n                          ")]));
            }
      }();
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("right-panel")
              ,$Html$Attributes.style($HtmlToElmWebsite$Layout.rightPanel(windowDimensions))]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.style($HtmlToElmWebsite$Layout.panelHeader)
                      ,$Html$Attributes.$class("right-panel-heading")]),
              _U.list([$Html.text("Elm code appears here (see ")
                      ,A2($Html.a,
                      _U.list([$Html$Attributes.href("https://github.com/evancz/elm-html")
                              ,$Html$Attributes.target("_blank")]),
                      _U.list([$Html.text("elm-html")]))
                      ,$Html.text(")")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.style($HtmlToElmWebsite$Layout.panelContent(windowDimensions))
                      ,$Html$Attributes.$class("elm-code")]),
              _U.list([hint
                      ,A2($Html.pre,
                      _U.list([$Html$Attributes.id("elm-code")
                              ,$Html$Attributes.$class("elm")]),
                      _U.list([]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.style($HtmlToElmWebsite$Layout.panelHeader)
                      ,$Html$Attributes.$class("right-panel-heading")]),
              _U.list([$Html.text("indent spaces: ")
                      ,A2($Html.span,
                      _U.list([$Html$Attributes.$class("example-button")
                              ,A2($Html$Events.onClick,address,SetIndentSpaces(2))]),
                      _U.list([$Html.text("2")]))
                      ,A2($Html.span,
                      _U.list([$Html$Attributes.$class("example-button")
                              ,A2($Html$Events.onClick,address,SetIndentSpaces(4))]),
                      _U.list([$Html.text("4")]))]))
              ,copyButton(true)]));
   });
   var snippetButton = F2(function (snippetName,address) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("example-button")
              ,A2($Html$Events.onClick,address,LoadSnippet(snippetName))]),
      _U.list([$Html.text(snippetName)]));
   });
   var snippetButtons = function (address) {
      return A2($List.map,
      function (key) {
         return A2(snippetButton,key,address);
      },
      $Dict.keys($HtmlToElmWebsite$HtmlExamples.htmlExamples));
   };
   var topBar = A2($Html.div,
   _U.list([$Html$Attributes.$class("top-bar")
           ,$Html$Attributes.style($HtmlToElmWebsite$Layout.topBar)]),
   _U.list([A2($Html.div,
   _U.list([]),
   _U.list([A2($Html.p,
           ...
           _U.list([A2($Html.a,
                   _U.list([$Html$Attributes.href("https://github.com/mbylstra/html-to-elm")
                           ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                            ...
                                                            ,_1: "10px"}]))]),
                   _U.list([A2($Html.img,
                           _U.list([$Html$Attributes.src("https://cdn0.iconfinder.com/data/icons/octicons/1024/mark-github-16.png")
                                   ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                                    ,_0: "vertical-align"
                                                                    ,_1: "text-top"}]))]),
                           _U.list([]))
                           ,$Html.text(" https://github.com/mbylstra/html-to-elm")]))
                   ,$HtmlToElmWebsite$HtmlComponents.githubStarButton({user: "mbylstra"
                                                                      ,repo: "html-to-elm"
                                                                      ,type$: "star"
                                                                      ,size: "small"
                                                                      ,style: _U.list([{ctor: "_Tuple2"
                                                                                       ,_0: "vertical-align"
                                                                                       ,_1: "middle"}
                                                                                      ,{ctor: "_Tuple2",_0: "margin-top",_1: "-5px"}])})]))]))]));
   var currHtmlMailbox = $Signal.mailbox("");
   var leftPanel = F2(function (windowDimensions,address) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("left-panel")
              ,$Html$Attributes.style($HtmlToElmWebsite$Layout.leftPanel(windowDimensions))]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.style($HtmlToElmWebsite$Layout.panelHeader)
                      ,$Html$Attributes.$class("left-panel-heading")]),
              _U.list([$Html.text("Type or paste HTML here")]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.textarea,
              _U.list([$Html$Attributes.type$("string")
                      ,$Html$Attributes.id("html")
                      ,$Html$Attributes.placeholder("input")
                      ,$Html$Attributes.name("points")
                      ,A3($Html$Events.on,
                      "input",
                      $Html$Events.targetValue,
                      function (v) {
                         return A2($Signal.message,currHtmlMailbox.address,v);
                      })]),
              _U.list([]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.style($HtmlToElmWebsite$Layout.panelHeader)
                      ,$Html$Attributes.$class("left-panel-heading")]),
              A2($Basics._op["++"],
              _U.list([$Html.text("snippets: ")]),
              snippetButtons(address)))]));
   });
   var view = F3(function (actionAddress,model,windowDimensions) {
      return A2($Html.div,
      _U.list([]),
      _U.list([topBar
              ,A2($Html.div,
              _U.list([]),
              _U.list([A2(leftPanel,windowDimensions,actionAddress)
                      ,A3(rightPanel,windowDimensions,model,actionAddress)]))]));
   });
   ...
   return _elm.Main.values = {_op: _op
                             ,currHtmlMailbox: currHtmlMailbox
                             ,topBar: topBar
                             ,snippetButton: snippetButton
                             ,snippetButtons: snippetButtons
                             ,leftPanel: leftPanel
                             ,copyButton: copyButton
                             ,rightPanel: rightPanel
                             ,LoadSnippet: LoadSnippet
                             ,SetIndentSpaces: SetIndentSpaces
                             ...
                             ,actionsModelSignal: actionsModelSignal
